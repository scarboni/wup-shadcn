    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-20 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 border border-white/10 rounded-full text-sky-300 text-xs font-semibold mb-6 backdrop-blur-sm">
            <Tag size={13} />
          ...
          <div className="flex items-center justify-center gap-6 mt-8 text-sm">
            <div className="flex items-center gap-2 text-sky-300">
              <div className="w-2 h-2 rounded-full bg-sky-400" /> Next.js 15
            </div>
            <div className="flex items-center gap-2 text-sky-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {PHASES.map((phase) => (
            <Link
              key={phase.phase}
              href={phase.href}
              className="group bg-white rounded-xl border border-slate-200 p-5 hover:shadow-lg hover:border-sky-200 transition-all"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-sky-600 transition-colors">
                      {phase.title}
                    </h3>
                  </div>
                ...
                <ArrowRight
                  size={16}
                  className="text-slate-300 group-hover:text-sky-500 group-hover:translate-x-1 transition-all shrink-0 mt-1"
                />
              </div>
            </Link>
          ))}
